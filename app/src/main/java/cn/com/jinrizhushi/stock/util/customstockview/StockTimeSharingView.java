...
public class StockTimeSharingView extends View {
    ...
    private void initTextPoint() {
        ...
        StockTextModel modelTen= new StockTextModel("10:30",STOCK_VIEW_STARTX+distanceX,timeY,paint);
        StockTextModel modelEleven = new StockTextModel("11:30/13:30",STOCK_VIEW_STARTX+distanceX*2,timeY,paint);
        StockTextModel modelForth = new StockTextModel("14:00",STOCK_VIEW_STARTX+distanceX*3,timeY,paint);
